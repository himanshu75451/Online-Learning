...
let toursData = [
  {
    id: 1,
    type: "International",
    location: "England Scotland Ireland Wales London",
    image: "/images/tours/england.webp",
    Countries: 4,
    Cities: 17,
    rating: 2.5,
    price: 480000,
  },
  {
    id: 2,
    type: "International",
    location: "Iceland Scandinavia Northern Lights",
  ...
  },
  {
    id: 3,
    type: "National",
    location: "Sikkim Darjeeling Gangtok",
    image: "/images/tours/Sikkim.jpg",
    Countries: 1,
    Cities: 7,
    rating: 4.8,
    price: 59000,
  },
  {
    id: 4,
    type: "National",
    location: "YOLO Adventures Leh Nubra Pangong Hanle",
    image: "/images/tours/leh.jpg",
    Countries: 1,
    Cities: 6,
    rating: 2.1,
    price: 75000,
  },
  {
    id: 5,
    type: "National",
    location: "The Great Indian Peninsula Road Trip",
    image: "/images/tours/IndianPeninsula.jpg",
    Countries: 1,
    Cities: 32,
    rating: 1.2,
    price: 375000,
  ...
  },
  {
    id: 7,
    type: "International",
    location: "Wonders of Sri Lanka",
    image: "/images/tours/SriLanka.jpg",
    Countries: 1,
    Cities: 4,
    rating: 4.1,
    price: 135000,
  ...
  },
  {
    id: 9,
    type: "International",
    location: "Seniors' Special Bhutan",
    image: "/images/tours/Bhutan.jpg",
    Countries: 2,
    Cities: 7,
    rating: 1.9,
    price: 85000,
  },
  {
    id: 10,
    type: "National",
    location: "Amritsar Attari Wagah Border",
    image: "/images/tours/Amritsar.jpg",
    Countries: 1,
    Cities: 4,
    rating: 2.5,
    price: 55000,
...
data.map(({ submission_link: url, id }) => {
  describe("Test", () => {
    ...
    it("Shows the correct initial data", () => {
      ...
      let numOfCats = toursData.length;
      ...
      cy.get(cards)
        ...
        .first()
        .should("contain", toursData[0].location);

      cy.get(cards)
        .eq(Math.ceil(numOfCats / 2))
        .should("contain", toursData[Math.ceil(numOfCats / 2)].location);

      cy.get(cards)
        .last()
        .should("contain", toursData[numOfCats - 1].location);
    ...
    it("Filters as expected", () => {
      ...
      cy.get("#filter-National-tours").click();
      cy.wait(500);
      ...
      cy.get("#filter-International-tours").click();
      cy.wait(500);
    ...
    it("Booking tickets message on click of Book Now link", () => {
      cy.visit(url);
      let numOfTours = toursData.length;
      cy.log(numOfTours + " employees found in the server");
      ...
      cy.get(cards)
        ...
        .then(() => {
          cy.get("#ticket-book-card").should(
            "contain",
            `Ticket Booking for : ${toursData[0].location}!`
          );
        });

      cy.get(cards)
        .eq(Math.ceil(numOfTours / 2))
        .find("a.card-link")
        .click()
        .then(() => {
          cy.get("#ticket-book-card").should(
            "contain",
            `Ticket Booking for : ${
              toursData[Math.ceil(numOfTours / 2)].location
            }!`
          );
        });
      ...
      cy.get(cards)
        ...
        .then(() => {
          cy.get("#ticket-book-card").should(
            "contain",
            `Ticket Booking for : ${toursData[numOfTours - 1].location}!`
          );
        });
